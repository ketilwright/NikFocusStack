...
enum MsgType
{
    eButtonActionPress		= 0x0000,
    eButtonActionRelease	= 0x0001,
    eButtonActionHoldShort  = 0x0002,
	eButtonActionHoldMedium = 0x0003,
	eButtonActionHoldLong   = 0x0004,
    eButtonActionNone	    = 0xffff
};
